...
class ATSTNorm(nn.Module):
    def __init__(self):
        ...
        self.amp_to_db = AmplitudeToDB(stype="power", top_db=80) # Audio feature extraction
        self.scaler = TorchScaler("instance", "minmax", [0, 1]) # MinMax(min=-79.6482,max=50.6842)
...
class ATSTSEDFeatureExtractor(nn.Module):
    ...
    def forward(self, mixture):
        ...
        atst_feats = self.atst_norm(self.atst_feat_extractor(mixture))
